...
contract EtherTrialsTRIAv5 {
    ...
    /**
     * @notice Get user entry info - SPLIT TO AVOID STACK TOO DEEP
     */
    function getUserEntry(uint256 period, uint256 fid) external view returns (
        bool exists,
        uint256 entryAmountETH,
        uint256 entryWeight,
        address wallet
    ...
    /**
     * @notice Get user score commitment info
     */
    function getUserCommitment(uint256 period, uint256 fid) external view returns (
        bool hasCommitted,
        bool hasRevealed,
        uint256 score
    ) {
    ...
    /**
     * @notice Get user claim status and pending rewards
     */
    function getUserClaim(uint256 period, uint256 fid) external view returns (
        bool hasClaimed,
